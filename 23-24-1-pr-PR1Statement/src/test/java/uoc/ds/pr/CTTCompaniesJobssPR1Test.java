...
public class CTTCompaniesJobssPR1Test {
    ...
    public void addCompanyTest() {
        ...
        Company company1000 = this.cttCompaniesJobs.getCompany();
        ...
        Company companyXXX = this.cttCompaniesJobs.getCompany();
        ...
        companyXXX = this.cttCompaniesJobs.getCompany();
    ...
    public void updateRequestTest() throws DSException {
        ...
        System.out.printf(String.valueOf(request1));
